...
export const PRIVATE_LOG_SIZE_IN_BYTES = 576;
...
export const PRIVATE_CIRCUIT_PUBLIC_INPUTS_LENGTH = 500;
...
export const COMBINED_ACCUMULATED_DATA_LENGTH = 547;
...
export const PRIVATE_KERNEL_CIRCUIT_PUBLIC_INPUTS_LENGTH = 1878;
export const PUBLIC_ACCUMULATED_DATA_LENGTH = 1023;
export const NUM_PUBLIC_ACCUMULATED_DATA_ARRAYS = 8;
export const PRIVATE_TO_PUBLIC_ACCUMULATED_DATA_LENGTH = 578;
...
export const PRIVATE_TO_PUBLIC_KERNEL_CIRCUIT_PUBLIC_INPUTS_LENGTH = 1199;
export const PUBLIC_KERNEL_CIRCUIT_PUBLIC_INPUTS_LENGTH = 2932;
export const VM_CIRCUIT_PUBLIC_INPUTS_LENGTH = 2341;
export const KERNEL_CIRCUIT_PUBLIC_INPUTS_LENGTH = 601;
...
export const AVM_PROOF_LENGTH_IN_FIELDS = 4181;
